 ...
 *
 */
public class TransactionJDBCContextOld implements TransactionContext, Cloneable {
	...
	final TransactionJDBCContextOld other = (TransactionJDBCContextOld) obj;
	...
	final TransactionJDBCContextOld t = (TransactionJDBCContextOld) super.clone();
	final List queriesTransaction = (List) refQueriesTransaction.get();
	if (queriesTransaction == null) {
